...
<body>
  <?php
    if(!isset($_SESSION['userID']) || $_SESSION['userID'] === ''){ ?>
      <script>window.location.href = "DODesk-login.php";</script>
    <?php }
  ?>
  <div class="wrapper">
    <div class="left-side">
        ...
        <div class="cards-wrapper" style="--delay: .6s">
          ...
          <div class="account-wrapper" style="--delay: .8s">
            <div class="account-profile">
              ...
              <div class="account-name" id="accountName" >firstName MiddleName lastName</div>
              <div class="account-title" id="accountRole">role</div>
            </div>
    ...
    <script src="../JAVASCRIPT/DODesk-DashboardJS.js"></script>
</body>
