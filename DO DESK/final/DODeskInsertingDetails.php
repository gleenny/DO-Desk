  ...
  ?>
    ...
    <div class="wrapper">
        <div class="left-side">
            ...
            <!--http://127.0.0.1:5500/Final%20HTML/DODesk-login.html-->
            ...
            <a class="header-link" href="DODeskLogin.php"><svg viewBox="0 0 512 512" fill="currentColor">
          ...
          <div class="main-container">
            <div class="header">
             ...
             <a class="header-link" href="DODeskRecords.php"><svg viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" fill="currentColor">
