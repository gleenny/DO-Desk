...
<body>
  <div class="wrapper">
    ...
    <div class="main-container">
      <div class="header">
        <a class="header-link active" href="DODESK-Dashboard.html#"><svg
        ...
        <a class="header-link" href="DODesk-Records.html"><svg viewBox="0 0 24 24"
        ...
        <a class="header-link" href="DODesk-Reports.html"><svg viewBox="0 0 512 512"
            xmlns="http://www.w3.org/2000/svg" fill="currentColor">
            <path
        ...
        <a class="header-link" href="DODesk-Events.html"><svg viewBox="0 0 512 512"
            xmlns="http://www.w3.org/2000/svg" fill="currentColor">
            <path
      ...
      <div class="user-box first-box">
        <!--Filtering Admin-->
        <form id="searchForm">
              <input class="textType" type="text" name="adminNumber" id="searchNumber" placeholder="Admin Number">
              <input class="textType" type="text" name="adminName" id="searchName" placeholder="Admin Name">
              <input class="textType" type="text" name="adminRole" id="searchRole" placeholder="Admin Role">
              <select class="textType" name="status" id="status" value=" ">
                <option value=""> </option>
                  <option value="Resolve">Active</option>
        ...
        <!--modal for Admin-->
            ...
            <!-- Trigger/Open The Modal -->
             <!--btn1-->
            <button class="cards-button button" id="btnRegister">Register Disciplinary Officer</button>
              ...
              <div class="modal-content">
                ...
                <!--Adding Admin-->
                  <form action="../JAVASCRIPT/DODesk-RecordsJS.js" enctype="multipart/form-data" method="POST" id="myform">
                    <div class="title">Register Disciplinary</div>
                    <input type="text" placeholder="Student First Name" id="adminFirstName">
                    <input type="text" placeholder="Student Middle Name" id="adminMiddleName">
                    <input type="text" placeholder="Student Last Name" id="adminLastName">

                    <select name="adminRole" id="adminRole" value=" ">
                    <option value=" "> </option>
                      <option value="Admin Disciplinary Officer">Admin Disciplinary Officer</option>
                    ...
                    <input type="text" placeholder="Email Account" id="adminEmail">
                    <input type="text" placeholder="Password" id="addPassword">


                    <input type="submit" value="Submit Register Admin" name="submit" > 
                  </form>
              </div>
            </div>
            ...
            <!-- Trigger/Open The Modal -->
            <button class="cards-button button" id="btnUpdateRole">Update Role</button>

            <!-- The Modal -->
            <div id="modalUpdateRole" class="modal">
              <!-- Modal content -->
              <div class="modal-content">
                <span class="close">&times;</span>
                <form action="../JAVASCRIPT/DODesk-RecordsJS.js" enctype="multipart/form-data" method="POST" id="updateRoleForm">
                  <div class="title">Update Status</div>
                  <input type="text" placeholder="adminID" id="adminID">
                  <select name="adminRole" id="adminRole" value=" ">
                      <option value=" "> </option>
                      <option value="Admin Disciplinary Officer">Admin Disciplinary Officer</option>
                      <option value="Disciplinary Officer">Disciplinary Officer</option>
                    </select>
                  <input type="submit" value="Update Admin Status" name="submit" >
                </form>
              </div>
            </div>
              ...
              <div id="modalUpdateStatus" class="modal">
                ...
                <div class="modal-content">
                  ...
                  <form action="../JAVASCRIPT/DODesk-RecordsJS.js" enctype="multipart/form-data" method="POST" id="updateStatusForm">
                    <div class="title">Update Admin Status</div>
                    <input type="text" placeholder="adminID" id="adminID">
         ...
         <div class="user-box third-box">
           ...
           <div class="cards-wrapper" style="--delay: 1s">
            ...
            <div class="cards-view">
              ...
              <span class="today"> Disciplinary Officer List</span>
            </div>
            </div>
